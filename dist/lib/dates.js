...
export function nowSqlDateTime(now = new Date()) {
...
export function sqlDateTimeIn(seconds, now = new Date()) {
 ...
 */
export function financialYear(isoDate = today()) {
...
export function financialYearBounds(fy) {
...
export function previousWorkingDay(isoDate) {
...
export function formatDateTime(sqlDateTime) {
    if (!sqlDateTime)
        return '';
...
export function relativeDays(isoDate, from = today()) {
