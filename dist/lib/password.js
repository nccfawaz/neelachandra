 ...
 */
export const DUMMY_HASH = '$argon2id$v=19$m=19456,t=2,p=1$YmFzZWxpbmVub25jZXNhbHQ$C4gQvxCTaJhV2xIQnBhKUuJ4rEGwHiKzWFmqBoWJvXo';
export async function burnVerify(plain) {
 ...
 */
export async function checkPasswordPolicy(plain, context = {}) {
    const problems = [];
...
export async function assertPasswordPolicy(plain, context = {}) {
